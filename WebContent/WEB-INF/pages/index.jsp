	...
	<div class="header">
		<div class="menu-bar nav">
			...
			<div class="right-part">
				...
				<r:identity role="provider">
				    <div class="warn">!</div>
					<a href="<spring:url value="/provider/portal" />" class="header-item login-item" target="_self" title="<r:outName />"><r:outName /><div class="warnWindom"><div class="divImg"></div><div>sss</div></div></a>
					<a href="<spring:url value="/login/loginout" />" class="header-item login-item" target="_self">登出</a>
				</r:identity>
				<r:identity role="employee">
