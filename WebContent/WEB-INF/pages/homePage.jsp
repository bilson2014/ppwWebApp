...
<body>
    ...
    <div class="page">
        ...
        <div class="flex-wrap">
            <div class="flexVideo">
                <video preload="auto" loop="" autoplay poster="../resources/images/banner/flex2.jpg" class="video-bg">
            ...
            <div class="new-banner">
                <div class="search-box" id="banner-search">
                    <form method="get" action="/search" id="s-form" class="bannerOut">
                        ...
                        <button class="helpYou">帮我推荐</button>
                        <div class="wordPosition">
                            <div class="bannerWord"><img src="../newHomePage/resources/images/index/bannerOnline.png">在线估价<span>>></span></div>
                            <div class="bannerWord" id="showVideoS"><img src="../newHomePage/resources/images/index/bannerPai.png">拍片网介绍<span>>></span></div>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="swiper-container swiperCover">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide coverSlide">
                        <div class="scaleDiv">
                            <img src="../newHomePage/resources/images/index/test1.png">
                    ...
                    <div class="swiper-slide coverSlide">
                        <div class="scaleDiv">
                            <img src="../newHomePage/resources/images/index/test2.png">
                            <div class="coverContent">
                                <div>什么什么的某个宣传片</div>
                                <div>￥598,00</div>
                            </div>
                    ...
                    <div class="swiper-slide coverSlide">
                        <div class="scaleDiv">
                            <img src="../newHomePage/resources/images/index/test3.png">
                            <div class="coverContent">
                                <div>什么什么的某个宣传片</div>
                                <div>￥598,00</div>
                            </div>
                        ...
                        <div class="swiper-slide">
                                ...
                                <div class="advanContent">
                                    ...
                                    <div class="service">
                                        ...
                                        <ul>
                                            <li>
                                                <div>
                                                    <img src="../newHomePage/resources/images/index/service1.png"> 1.需求沟通
                                                </div>
                                                <div>1对1沟通详细了解您的拍片需求</div>
                                            </li>
                                            <li>
                                                <div>
                                                    <img src="../newHomePage/resources/images/index/service2.png"> 2.创意策划
                                                </div>
                                                <div>为您提供免费的创意策划提出合理建议</div>
                                            </li>
                                            <li>
                                                <div>
                                                    <img src="../newHomePage/resources/images/index/service3.png"> 3.商务流程
                                                </div>
                                                <div>签订合作协议，制作费托管到平台</div>
                                            </li>
                                            <li>
                                                <div>
                                                    <img src="../newHomePage/resources/images/index/service4.png"> 4.执行方案
                                                </div>
                                                <div>制定详细脚本，为您甄选最佳执行导演</div>
                                            </li>
                                            <li>
                                                <div>
                                                    <img src="../newHomePage/resources/images/index/service5.png"> 5.拍摄制作
                                                </div>
                                                <div>前期拍摄和后期制作，视频管家全程监管</div>
                                            </li>
                                            <li>
                                                <div>
                                                    <img src="../newHomePage/resources/images/index/service6.png"> 6.影片交付
                                                </div>
                                ...
                                <div class="newsContent">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="newsMore"><span>了解更多</span><img src="../newHomePage/resources/images/index/newsMore.png"></div>
                                        </li>
                                        <li>
                                            <div class="newsTitle">新闻标题</div>
                                            <div class="newsLine"></div>
                            ...
                            <div class="join">
                                <div class="joinContent">
                                    <ul>
                                        <li>
                                            <div>500<span>+</span><span>家</span></div>
                                            <div>合作客户</div>
                                        </li>
                                        <li>
                                            <div>5960<span></span><span>部</span></div>
                                            <div>累计制作影片</div>
                                        </li>
                                        <li>
                                            <div>35800<span>+</span><span>位</span></div>
                                            <div>专业创作者加盟</div>
                                        </li>
                                    </ul>
                                    <div class="joinBtn">
