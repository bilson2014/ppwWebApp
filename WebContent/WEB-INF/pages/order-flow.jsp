...
<%-- import CSS --%>
<spring:url value="/resources/css/order-flow.css" var="orderFlowCss"/>
...
<head>
	...
	<link rel="stylesheet" href="${orderFlowCss }">
	<!--[if lt IE 9]>
	...
	<div class="page">
		<div class="contain nav-title-wrap" >
			<ul class="ul-wrap" id="selects">
				...
				<a href="<spring:url value='/order-flow.html' />" class ="nav-title"><li id="first-title">服务流程</li></a>
		...
		<div class="contain area-top" >
			<img class="image-top" src="${imgPath }/introduce/order-flow/step.png"></img>
		</div>
	</div>
