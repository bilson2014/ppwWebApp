...
<head>
    ...
    <spring:url value="/resources/lib/js/common3.js" var="common3Js"/>
    ...
    <div class="page">
        ...
        <div class="tagsWidth">
            ...
            <div class="icon icon1 RightIcon">
                <div>
                    <label>需求沟通</label>
                    <label>您只需要填写电话号 码,点击下单.
                            <br>视频管家就会上门, 一对一服务,了解您 的需求.</label>
...
<br>Within your budget, the specialist will find the best match from 5208 experienced directors all over the world. 
            ...
            <div class="icon icon3 RightIcon">
                <div>
                    <label>商务流程</label>
                    <label>您将制作费托管到拍 片网平台,导演团队 就开始干活了! </label>
            ...
            <div class="icon icon4 LeftIcon">
                <div>
                    <label>执行文案</label>
                    <label>选演员、选场地、前 期拍摄、后期制作、 配音配乐,视频管家 会替您全程监管. </label>
...
<!--     <div class="comOrder">
    ...
    <script type="text/javascript" src="${common3Js }"></script>
