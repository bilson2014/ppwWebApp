...
<spring:url value="/resources/css/phone/login/phoneThreeLogin.css" var="phoneLoginCss"/>

<%-- import JS --%>
<spring:url value="/resources/lib/jquery/jquery-2.0.3.min.js" var="jqueryJs"/>
<spring:url value="/resources/lib/jquery/plugins.js" var="pluginJs"/>
<spring:url value="/resources/lib/phone/login/phoneLogin.js" var="phoneLoginJs"/>
...
<body>
	      ...
	      <div class="topDiv">
	        ...
	        <div class="topContent">
	            ...
	            <div><img id="posLogo" src="${imgPath}/phone/login/logo.png" ></div>
