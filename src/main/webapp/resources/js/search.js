...
// 行业维度
var busArray = new Array('智能硬件','教育','医疗保健','互联网','电商','旅游','母婴','体育','金融','电子产品','大数据','游戏','服装纺织','家居建材','餐饮美食','食品','饮料','农业','房地产','创投','首饰','日用美妆','云计算');
// 制作维度
var proArray = new Array('MG动画','Flash动画','明星演员','包装','三维','航拍','动画','电影级','广告级','长镜头','定格动画');
