...
<spring:url value="/resources/js/provider/registerFlow/register.js" var="registerJs" />
...
<body>
						...
						<div class="user-img-content" id="user-img-content">
							<div class="user-icon">
								<img alt="用户头像" src="/resources/images/provider/initLogo.png"
									class="img-circle" id="user-img" />
								<form:input type="hidden" path="teamPhotoUrl" id="user_img_url" />
							</div>
							<div class="upload-info">
								<label>您可以上传JPG、GIF或PNG格式的图片文件，文件大小不能超过10M</label>
							</div>
					...
					<div class="input-group-div" id="company-nature-error">
						...
						<div class="radioDiv">
							<label><form:radiobutton path="teamNature" class="radio"
									...
									path="teamNature" class="radio" value="1" id="checkWorkRoom" />工作室
							</label>
						</div>
					</div>
				...
				<div class="input-group-div" id="company-priceRange-error">
					...
					<div class="input-group-div" id="cityError">
						...
						<div class="dropdown leaderSelect select-city"
							...
							<button
								class="btn btn-default dropdown-toggle step-two-select-city"
								type="button" id="dropdownMenu1" data-toggle="dropdown">
								<span data-value="" id='getProvince'></span>
								<div class="carets"></div>
							</button>
							<ul class="dropdown-menu" id="selectUlProvince" role="menu"
								aria-labelledby="dropdownMenu1">
							</ul>
						</div>
					...
					<div class="input-group-div" id="addressError">
						...
						<form:input path="address" class="form-control step-one-input"
							id="company-address" placeholder="请填写详细地址 " />
					</div>
					...
					<div class="input-group-div" id="companyDataError">
						...
						<form:input path="establishDate"
							class="form-control step-one-input" id="company-data"
					...
					<div class="updateLogo example">
						...
						<div class="user-img-content" id="user-img-contentInfo">
							...
							<div class="logoItem">
								<div class="user-icon">
									<img alt="上传资质" src="/resources/images/provider/initLogo.png"
										class="img-circle" id="user-img-info" />
									<form:input path="certificateUrl" type="hidden"
										id="user_img_url_Info" />
								</div>
							...
							<div class="logoItem">
								<div class="user-icon">
									<img alt="身份证正面" src="/resources/images/provider/initLogo.png"
										class="img-circle" id="user-img-z" />
									<form:input path="idCardfrontUrl" type="hidden"
										id="user_img_url_Z" />
								</div>
							...
							<div class="logoItem">
								<div class="user-icon">
									<img alt="身份证背面" src="/resources/images/provider/initLogo.png"
										class="img-circle" id="user-img-b" />
									<form:input path="idCardbackUrl" type="hidden"
										id="user_img_url_B" />
								</div>
	...
	<div class="setMid">
		<input type="hidden" name="_flowExecutionKey"
			value="${flowExecutionKey}" /> <input class="red-btn btn-c-r "
	...
	<div class="tooltip-warn-banner" id="tooltip-warn-banner">
		<div class="card">
			...
			<div class="imgContent">
				<img src="/resources/images/provider/checkZInfo.jpg" id="previewImg"
					class="previewImg" style="width: 650px; height: 358px;">
			</div>
		</div>
	</div>
	...
	<div class="tooltip-warn-banner " id="tooltip-warn-bannerZ">
		<div class="card">
			...
			<div class="imgContent">
				<img src="/resources/images/provider/checkZ.jpg" id="previewImg"
					class="previewImg" style="width: 650px; height: 358px;">
			</div>
		</div>
	</div>
	...
	<div class="tooltip-warn-banner " id="tooltip-warn-bannerB">
		<div class="card">
			...
			<div class="imgContent">
				<img src="/resources/images/provider/checkB.jpg" id="previewImg"
					class="previewImg" style="width: 650px; height: 358px;">
			</div>
		</div>
	</div>

	<div class="tooltip-warn-banner verBanner "
		id="tooltip-warn-bannerInfo">
		<div class="card">
			<div class="top">
				<div class="topBanner closeBanner"></div>
			</div>
			<div class="imgContent">
				<img src="/resources/images/provider/theInfo.jpg" id="previewImg"
					class="previewImg" style="width: 450px; height: 457px;">
			</div>
		</div>
	</div>
