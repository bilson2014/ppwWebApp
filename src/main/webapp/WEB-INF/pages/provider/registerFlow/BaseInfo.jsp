...
<spring:url value="/resources/js/flow/BaseInfo.js" var="BaseInfoJs" />
...
<body>
	...
	<div class="page">
		...
		<div class="step">
			...
			<div class="step-two-div" id="step2" style="display: block"
				data-step="2">
				<form:form commandName="team">
					<div class="input-group-div" id="company-linkman-error">
						<span class="title-word">联系人姓名</span>
						<form:input path="linkman" class="form-control step-one-input"
							id="company-linkman" placeholder="请填写联系人姓名" />
					</div>
					...
					<div class="input-group-div noStar" id="company-webchat-error">
						...
						<form:input path="webchat" class="form-control step-one-input"
							id="company-webchat" placeholder="请填写微信" />
					</div>
					<div class="input-group-div noStar" id="company-qq-error">
						<span class="title-word">QQ</span>
						<form:input path="qq" class="form-control step-one-input"
							id="company-qq" placeholder="请填写QQ" />
					</div>
					<div class="input-group-div noStar" id="company-phone-errors">
						<span class="title-word">座机</span>
						<form:input path="telNumber" class="form-control step-one-input"
							id="company-phone" placeholder="请填写座机" />
					</div>
				</form:form>
				<div class="bottom-div">
					<input type="hidden" name="_flowExecutionKey"
						value="${flowExecutionKey}" /> <input class="gy-btn"
						type="submit" name="_eventId_cancel" id="step2Pre" value="上一步">
					<input class="red-btn btn-c-r" id="step2Next" type="button"
						name="_eventId_doRegister" value="下一步">
				</div>
			</div>
		</div>
		<!-- foot -->
