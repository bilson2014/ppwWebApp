...
<spring:url value="/resources/css/order/orderCancle.css" var="orderCss"/>
<spring:url value="/resources/lib/jquery/jquery-2.0.3.min.js" var="jqueryJs"/>
<spring:url value="/resources/lib/Clamp/clamp.js" var="clampJs"/>
<spring:url value="/resources/js/common.js" var="commonJs"/>
<spring:url value="/resources/js/order/orderCancle.js" var="orderCancleJs"/>
...
<!--          <div class="showStatus">
    ...
    <script type="text/javascript" src="${orderCancleJs}"></script>
</body>
