	...
	<div class="page" id='filmmaking'>
		<div class="managerPgae">
			...
			<!-- 			<p class='pickpro'>制片人</p> -->
					...
					<div class='peoplebox'>
						...
						<div class='profession other'>
							<div class='peoplel'>
								...
								<span>价格(元/天)</span> <input class='pricepeo' type='text'
									onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入数字">
					...
					<!-- 添加摄影师 -->
					<div class='cameramanbox'>
						<div class='cameramantitle'>
							<span>创建摄影师</span> <img alt="关闭"
								src="/resources/images/supplier/close.png">
						</div>
						<div class='cameraman'>
							<div class='cameramanl'>
								...
								<div class='specialSkillcheck'>
									<p key='1'>水下拍摄</p>
									<p key='2'>航拍</p>
								</div>

								<span>所在城市</span>
								<div class='cityca'>请选择</div>
								<img class='cityimg' alt=""
									src="/resources/images/supplier/more.png">
								...
								<span>价格(元/天)</span> <input class='priceca' type='text'
									onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入数字">
								<p class='pricecap errorp'></p>


							</div>
							<div class='cameramanr'>
								<div class='tipsimage'>
						...
						<div class='remark'>
							<span>备注</span>
							<textarea class='remarkca' rows="4" cols="550"
								placeholder="请完善摄影师简历以及作品等信息"></textarea>
						</div>
						<!--提交按钮  -->
						<div class='gatherbut'>
							<div class='sure'>确认</div>
